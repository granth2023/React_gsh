    ...
    >
      <div>
        ...
        >
          ...
          <h1 style={{ opacity: 0 }} className="font-gothic"></h1>
            ...
            <div className="w-full">
              <div className="flex justify-center">
                <div className="flex flex-col">
                  <div className="flex flex-col font-bold"></div>

                  <h3 className=" pt-8 text-xs sm:text-6xl text-center font-gothic w-full sm:w-3/4 lg:w-6/6 mx-auto leading-loose">
                    Artist writing original feature films, spec scripts adapted
                    from podcasts, adapatations of books, and other short
                    content.
                  </h3>
                </div>
              </div>
